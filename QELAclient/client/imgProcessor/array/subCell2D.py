...
def subCell2DSlices(arr, shape, d01=None, p01=None):
    ...
    yinit, d0, xinit, d1 = _param(arr, shape, d01, p01)
...
def _param(arr, shape, d01, p01):
    ...
    if d01 is not None:
        ...
        d0, d1 = s0 // g0, s1 // g1
    return yinit, d0, xinit, d1


def accessSubCell(arr, shape, n0, n1, d01=None, p01=None):
    yinit, d0, xinit, d1 = _param(arr, shape, d01, p01)
    y = yinit + n0 * d0
    x = xinit + n1 * d1
    return arr[y:y + d0, x:x + d1]
...
def subCell2DFnArray(arr, fn, shape, dtype=None, out=None, **kwargs):
    '''
